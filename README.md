...
- **파워워커 모드** — 물방울 오브 궤도 + 민트 비네트 + 화면 경고 효과
- **속도 슬로우** — ⏱️ 수집 시 6초간 모든 속도 절반
- **말풍선 시스템** — 게임 시작 인사 / 파워워커 / 살아있는 장애물 조우 시 출력
...
### 달빛길 보너스 구간
- 2000m 도달 시 진입 (난이도 최고 구간)
- 장애물 없음, 황금 빛나는 발자국만 등장
- 발자국 수집 시 **+20점** (2배)
- 별·유성·사이드 반짝이 효과
...
- 힐링 감성 우선 — 경쟁보다 동기부여, 함께걸어요 앱 디자인 언어 준수
